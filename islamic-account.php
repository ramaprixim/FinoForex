    ...
    <div class="dz-bnr-inr style-1 text-center">
        <div class="container">
            <div class="dz-bnr-inr-entry">
                ...
                <p class="text">Elevate Your Trading Ethically with Islamic Accounts (Swap-Free)</p>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Account</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Islamic Account</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
            ...
            <div class="col-lg-8">
                <div id="wrapper">
                    ...
                    <div>
                        ...
                        <p>Islamic accounts have exactly the same trading conditions and terms as our regular trading
                            account types. The only difference is that there are no swaps. Please make sure you comply
