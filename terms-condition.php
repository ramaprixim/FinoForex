        ...
        <div class="container">
            <div class="dz-bnr-inr-entry">
                ...
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="terms-condition.php">Terms & Condition</a></li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
...
<div class="container"
    ...
    <span style="font-size: 15px;">
        <h6>Welcome to FinoForex</h6>
        <p>These terms and conditions outline the rules and regulations for the use of FinoForex's Website, located at
            https://testingwebsite.xyz/finoforex/why-us.php.</p>
        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use FinoForex
    ...
    <span style="font-size: 15px;">
        <h6>Cookies :</h6>
        <p>We employ the use of cookies. By accessing FinoForex, you agreed to use cookies in agreement with the
            FinoForex's Privacy Policy.</p>
    ...
    <span style="font-size: 15px;">
        <h6>License :</h6>
        <p>Unless otherwise stated, FinoForex and/or its licensors own the intellectual property rights for all material
            on FinoForex. All intellectual property rights are reserved. You may access this from FinoForex for your own
    ...
    <span style="font-size: 15px;">
        <h6>You must not :</h6>
        <ul>
            <li style="list-style-type:disc;">Republish material from FinoForex</li>
            <li style="list-style-type:disc;">Sell, rent or sub-license material from FinoForex</li>
            <li style="list-style-type:disc;">Reproduce, duplicate or copy material from FinoForex</li>
            <li style="list-style-type:disc;">Redistribute content from FinoForex</li>
        </ul>
        <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the
            Free Terms and Conditions Generator.</p>
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. FinoForex does not filter, edit, publish or review Comments prior to their presence on
            the website. Comments do not reflect the views and opinions of FinoForex,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, FinoForex shall not be liable for the Comments or for any liability, damages
        ...
        <p>FinoForex reserves the right to monitor all Comments and to remove any Comments which can be considered
            inappropriate, offensive or causes breach of these Terms and Conditions.</p>

        <h6>You warrant and represent that :</h6>
        <ul>
            <li style="list-style-type:disc;">You are entitled to post the Comments on our website and have all
                necessary licenses and consents to do so.</li>
            <li style="list-style-type:disc;">The Comments do not invade any intellectual property right, including
                without limitation copyright, patent or trademark of any third party.</li>
            <li style="list-style-type:disc;">The Comments do not contain any defamatory, libelous, offensive, indecent
                or otherwise unlawful material which is an invasion of privacy.</li>
            <li style="list-style-type:disc;">The Comments will not be used to solicit or promote business or custom or
                present commercial activities or unlawful activity.</li>
        </ul>
        <br>
        <p>You hereby grant FinoForex a non-exclusive license to use, reproduce, edit and authorize others to use,
    ...
    <span style="font-size: 15px;">
        ...
        <ul>
            <li style="list-style-type:disc;">Government agencies</li>
            <li style="list-style-type:disc;">Search engines</li>
            <li style="list-style-type:disc;">News organizations</li>
            <li style="list-style-type:disc;">Online directory distributors may link to our Website in the same manner
                as they hyperlink to the Websites of other listed businesses</li>
            <li style="list-style-type:disc;">System wide Accredited Businesses except soliciting non-profit
        ...
        <ul>
            <li style="list-style-type:disc;">commonly-known consumer and/or business information sources</li>
            <li style="list-style-type:disc;">dot.com community sites</li>
            <li style="list-style-type:disc;">associations or other groups representing charities</li>
            <li style="list-style-type:disc;">online directory distributors</li>
            <li style="list-style-type:disc;">internet portals</li>
            <li style="list-style-type:disc;">accounting, law and consulting firms</li>
            <li style="list-style-type:disc;">educational institutions and trade associations.</li>
        </ul>
        <br>
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            FinoForex; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to FinoForex. Please include your name, your organization name,
        ...
        <ul>
            <li style="list-style-type:disc;">By use of our corporate name; or</li>
            <li style="list-style-type:disc;">By use of the uniform resource locator being linked to; or</li>
            <li style="list-style-type:disc;">By use of any other description of our Website being linked to that makes
                sense within the context and format of content on the linking party's site.</li>
        </ul>
        <br>
        <p>No use of FinoForex's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
    </span>
    ...
    <span style="font-size: 15px;">
        ...
        <ul>
            ...
            <li style="list-style-type:disc;">limit or exclude our or your liability for fraud or fraudulent
                misrepresentation;</li>
            <li style="list-style-type:disc;">limit any of our or your liabilities in any way that is not permitted
                under applicable law; or</li>
            <li style="list-style-type:disc;">exclude any of our or your liabilities that may not be excluded under
                applicable law.</li>
        </ul>
        <br>
