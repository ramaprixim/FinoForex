<?php include("includes/header.php"); ?>
	...
	<div class="page-content">
		...
		<section class="content-inner about-sec bg-primary-light" style="background-image: url(https://cryptozone.dexignzone.com/xhtml/page-error-404.html);">
			<div class="container">
				<div class="row about-bx2 style-1 align-items-center">
					...
					<div class="col-lg-6 about-content ps-lg-5 m-b30 wow fadeInUp" data-wow-delay="0.6s">
						<div class="section-head">
							...
							<p class="m-0 lh-base">We are an independent gym that is committed to working with you to gain the results you want. Whether your aim is to loose weight</p>
						</div>
			...
			<img class="bg-shape1" src="images/home-banner/shape1.png" alt="">
			<img class="bg-shape2" src="images/home-banner/shape3.png" alt="">
			<img class="bg-shape3" src="images/home-banner/shape3.png" alt="">
			<img class="bg-shape4" src="images/home-banner/shape3.png" alt="">
		</section>
			...
			<div class="container wow fadeInUp" data-wow-delay="0.4s">
				<div class="video-bx style-1">
					<div class="video-media">
						...
						<a href="https://www.youtube.com/watch?v=cfmQFW1DpA0" class="popup-youtube play-icon">
							<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M6.25 3.75L23.75 15L6.25 26.25V3.75Z" stroke="#9467FE" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
							</svg>
						</a>
					</div>
				</div>
		...
		<section class="content-inner bg-light pricing-plan-wrapper2">
			<img class="bg-shape2" src="images/home-banner/shape1.png" alt="">
			<div class="container">
				<div class="section-head text-center">
					<h2 class="title">Awesome Pricing Plan for <br> Cryptocurrency Business</h2>
				</div>
				<div class="row justify-content-center">
					<div class="col-xl-4 col-lg-6 col-md-6 m-b30 wow fadeInUp" data-wow-delay="0.2s">
						<div class="pricingtable-wrapper box-hover style-1">
							<div class="pricingtable-inner">
								...
								<div class="pricingtable-price">
									...
									<div class="days-label bg-primary">Try 7 Days for free</div>
									<h6>Life-includes:</h6>
								</div>
							...
							<div class="pricingtable-footer">
								<a href="contact-us.html" class="btn">See all features</a>
							</div>
						</div>
					</div>
					<div class="col-xl-4 col-lg-6 col-md-6 m-b30 wow fadeInUp" data-wow-delay="0.4s">
						<div class="pricingtable-wrapper box-hover style-1">
							<div class="pricingtable-inner">
							...
							<div class="pricingtable-footer">
								<a href="contact-us.html" class="btn"><span>See all features</span></a>
							</div>
						</div>
					</div>
					<div class="col-xl-4 col-lg-6 col-md-6 m-b30 wow fadeInUp" data-wow-delay="0.6s">
						<div class="pricingtable-wrapper box-hover style-1 active">
							<div class="pricingtable-inner">
								<h4 class="pricingtable-title">
		...
		<!-- form wrapper -->
		<section class="form-sec bg-light">
			<img class="bg-shape2" src="images/home-banner/shape1.png" alt="">
							...
							<form class="dzForm" method="POST" action="https://cryptozone.dexignzone.com/frontend/xhtml/script/contact_smtp.php">
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="0.6s">
										<button name="submit" type="submit" value="Submit" class="btn btn-dark btn-block h-100">Submit</button>
									</div>
								</div>
							</form>
						</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-7 col-lg-12">
						...
						<div class="dz-card style-1 blog-half m-b30 wow fadeInUp" data-wow-delay="0.4s">
							...
							<div class="dz-info">
								...
								<h4 class="dz-title"><a href="blog-details.html">Five Things To Avoid In Cryptocurrency.</a></h4>
					...
					<div class="col-xl-5 col-lg-12 m-b30 wow fadeInUp" data-wow-delay="0.8s">
						<div class="dz-card style-2" style="background-image: url(images/blog/blog-ig.png)">
							...
							<div class="dz-info">
								<h2 class="dz-title"><a href="blog-details.html" class="text-white">Directly support individuals Crypto</a></h2>
								<div class="dz-meta">
									<ul>
										<li class="post-author">
											<a href="javascript:void(0);">
