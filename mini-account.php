    ...
    <div class="dz-bnr-inr style-1 text-center">
        <div class="container">
            <div class="dz-bnr-inr-entry">
                <h1>Mini Account</h1>
                <p class="text">Ideal for Moderate Traders with Strategic Goals</p>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Account</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Mini Account</li>
                    </ul>
                </nav>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div id="wrapper">
                    ...
                    <div>
                        <h2>Mini Account</h2>
                        <p>Mini Account is designed to cater the needs of a moderate experienced trader who wish to take advantage of his trading 
                            strategies developed with low amount of deposit.</p>
                      </div>
        <h2 class="text-align">Mini Account</h2>
